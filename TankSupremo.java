...
public class TankSupremo extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        // -----------------------------
        // 🛡️ Seção de movimentação e defesa
        // -----------------------------

        // Se o inimigo estiver muito perto, recua com movimento aleatório
        if (enemyDistance < 200) {
            setBack(100 + random.nextInt(50));
        } else {
            // Caso contrário, avança em direção variável
        ...
        // Estratégia de sobrevivência: se a energia estiver baixa e o inimigo longe, recua
        if (getEnergy() < 30 && enemyDistance > 150) {
            setBack(100); // Move para trás e evita confronto direto
        }
    }
